...
set(h0,'ResizeFcn','cltidemo ResizeFcn');
...
'Tag','SetLineWidth1');
h3 = uimenu('Parent',h1, ...
'Callback','cltidemo Screenshot', ...
'Label','&Take Screen-shot...', ...
'Tag','Screenshot');
h4 = uimenu('Parent',h1, ...
'Callback','cltidemo ShowMenu', ...
'Label','&Show Menu', ...
'Tag','ShowMenu');
h1 = uimenu('Parent',h0, ...
'Callback','', ...
...
'XTickLabel',{'0','20','40','60','80','100','150','200'}, ... %'0|20|40|60|80|100|150|200',...
'XTickMode','manual', ...
